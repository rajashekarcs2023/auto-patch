...
Set it as an environment variable: PERPLEXITY_API_KEY=your_key_here
(Optional) Set a timeout for requests: PERPLEXITY_TIMEOUT_MS=600000. The default is 5 minutes.
Claude Code
